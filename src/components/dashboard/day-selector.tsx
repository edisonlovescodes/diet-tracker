          ...
          return (
            <button
              ...
              className={[
                ...
                state === "complete" && "surface-subtle border border-[color:var(--gray-a5)]",
            ...
            >
              <span>{day.label}</span>
              <span className="rounded-full surface-subtle px-2 py-0.5 text-[10px] font-bold uppercase tracking-wider text-foreground/70">
                {day.dateLabel}
              </span>
